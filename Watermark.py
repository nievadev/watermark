...
def clean_files(filetype):
    ...
    for _file in files:
        if _file in EXCEPTION_FILES:
            text.print_color('Warning: ', color='yellow', style='bright')
...
class Watermark:
    ...
    def _set_up_image(self):
        ...
        # In case no font is found in the directory
            ...
            text.print_color('Warning: ', color='yellow', style='bright')
            print('no font in directory, choosing a better-than-nothing font')
        ...
        if self.x in ('center', 'right'):
            ...
            text.print_color('Warning: ', color='yellow', style='bright')
            print('couldnt set X position, setting to 0. Check SUPPORTED_X global')
        ...
        if self.y in ('center', 'bottom'):
            ...
            text.print_color('Warning: ', color='yellow', style='bright')
            print('couldnt set Y position, setting to 0. Check SUPPORTED_Y global')
        ...
        def export():
            img.save('result' + '.' + IMAGE_EXPORT_EXTENSION)
